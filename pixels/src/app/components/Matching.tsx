                    ...
                    <div className='flex flex-col h-full w-1/2'>
                        ...
                        <div className='flex h-5/6 ml-3'>
                            <div className='flex flex-col basis-1/6'>
                                <button value={0} data-tag="1" onClick={to_rust} className={`text-slate-50 active:scale-90 ring-4 ring-offset-2 my-1 pixel-corners ${((players.locked & (1 << 0)) || !players.attacker) || players.disable_all ? 'bg-slate-500 ring-slate-600' : 'bg-orange-400 hover:bg-orange-600 ring-orange-700'} rounded-r-2xl`} disabled={((players.locked & (1 << 0)) || !players.attacker) || players.disable_all ? true : false}>Mend</button>
                                <button value={1} data-tag="1" onClick={to_rust} className={`text-slate-50 active:scale-90 ring-4 ring-offset-2 my-1 pixel-corners ${((players.locked & (1 << 1)) || !players.attacker) || players.disable_all ? 'bg-slate-500 ring-slate-600' : 'bg-orange-400 hover:bg-orange-600 ring-orange-700'} rounded-r-2xl`} disabled={((players.locked & (1 << 1)) || !players.attacker) || players.disable_all ? true : false}>Hex</button>
                                <button value={2} data-tag="1" onClick={to_rust} className={`text-slate-50 active:scale-90 ring-4 ring-offset-2 my-1 pixel-corners ${((players.locked & (1 << 2)) || !players.attacker) || players.disable_all ? 'bg-slate-500 ring-slate-600' : 'bg-orange-400 hover:bg-orange-600 ring-orange-700'} rounded-r-2xl`} disabled={((players.locked & (1 << 2)) || !players.attacker) || players.disable_all ? true : false}>Wall</button>
                                <button value={3} data-tag="1" onClick={to_rust} className={`text-slate-50 active:scale-90 ring-4 ring-offset-2 my-1 pixel-corners ${((players.locked & (1 << 3)) || !players.attacker) || players.disable_all ? 'bg-slate-500 ring-slate-600' : 'bg-orange-400 hover:bg-orange-600 ring-orange-700'} rounded-r-2xl`} disabled={((players.locked & (1 << 3)) || !players.attacker) || players.disable_all ? true : false}>TODO</button>
